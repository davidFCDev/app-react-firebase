        ...
        <section className='mx-16'>
            <main className='flex ml-10 mt-8'>
                <div className='flex flex-col w-44 md:w-60'>
                    <h1 className='text-xl md:text-3xl font-bold md:py-3 mt-16'>
                    ...
                    <p className='italic mt-4 md:mt-6 text-base text-center md:text-lg'>Start buying from our suppliers in more than fifteen countries.</p>
                </div>
                <img 
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-4 my-16 pb-20'>
                    ...
                    <div className='text-left px-6 md:px-10 py-5'>
                        <h1 className='font-bold text-red-800 text-base md:text-xl flex gap-3'>
                            Buy from anywhere
                            <FaShopify className='text-2xl text-red-700'/>
                        </h1>
                        <p className='pt-6 text-sm md:text-lg'>Download our App and buy from anywhere. </p>
