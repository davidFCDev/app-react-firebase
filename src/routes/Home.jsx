        ...
        <section className='mx-10'>
            <main className='flex ml-10 mt-8'>
                <div className='flex flex-col w-44 md:w-60'>
                    ...
                    <p className='italic mt-4 md:mt-6 text-sm md:text-lg'>Start buying from our suppliers in more than fifteen countries.</p>
                </div>
                <img 
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-4 my-14 pb-20'>
                    <img 
                        className='w-auto h-auto md:w-100 md:h-60 rounded-3xl shadow-lg shadow-zinc-200 hover:shadow-zinc-400' 
                        alt='' 
